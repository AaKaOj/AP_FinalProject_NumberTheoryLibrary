...
; //Developed by Aastha Girotra
int addMod (int a, int b, int mod); //Developed by Aastha Girotra

int subMod (int a, int b, int mod); //Developed by Aastha Girotra
int multiplyMod (int a, int b, int mod); //Developed by Aastha Girotra
int inverseMod(int a, int m); //Developed by Aastha Girotra
int expMod(int a, int b, int mod)
; //Developed by Aastha Girotra
int squareMod(int a, int mod)
; //Developed by Aastha Girotra
